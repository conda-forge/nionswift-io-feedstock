...
Once the `conda-forge` channel has been enabled, `nionswift-io` can be installed with:

```
conda install nionswift-io
```

It is possible to list all of the versions of `nionswift-io` available on your platform with:
